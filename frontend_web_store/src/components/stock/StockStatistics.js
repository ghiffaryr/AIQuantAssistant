...
export default function StockStatistics({ title, data, className }) {
  return (
    <>
      <Card
        variant="light"
      ...
      >
        <Card.Body>
          ...
          <div className="d-flex flex-row align-items-center stock-statistics-row pb-2 border-bottom border-2">
            <i className="bi bi-book medium-icons ps-4 pe-4"></i>
            <p className="flex-grow-1 fs-5 fw-bold text-muted">
              Price per book
            </p>
          ...
          <div className="d-flex flex-row align-items-center stock-statistics-row pb-2">
            <i className="bi  bi-credit-card-2-back medium-icons ps-4 pe-4"></i>
            <p className="flex-grow-1 fs-5 fw-bold text-muted">
              Debt to equity
            </p>
