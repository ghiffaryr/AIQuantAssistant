...
export const sData = {
  date_list: ['6/30/2023', '9/30/2023', '12/31/2023', '3/31/2024'],
  eps_actual_list: ['1.17', '1.35', '2.02', '1.42'],
};
...
export const statisticData = {
  ...
  market_cap_list: ['2.95T', '2.65T', '2.99T', '2.68T', '3.05T', '2.61T'],
  trailing_pe_list: ['29.90', '26.67', '31.41', '28.73', '32.88', '28.00'],
  price_per_book_list: ['39.73', '35.49', '47.90', '44.17', '49.08', '45.99'],
  diluted_eps: '6.42',
...
export default function StockPage() {
  ...
  const getTopGainer = async () => {
    try {
      let { status, data } = await axios.get(
        `${SCRAPPER_API}/scrapper/stock/gainers`,
      );
      const result = [];
  ...
  const getLowGainer = async () => {
    try {
      let { status, data } = await axios.get(
        `${SCRAPPER_API}/scrapper/stock/losers`,
      );
      const result = [];
      for (const x in Array.from(Array(5).keys())) {
        result.push({
