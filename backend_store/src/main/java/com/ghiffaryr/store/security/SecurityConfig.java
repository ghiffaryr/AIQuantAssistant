package com.ghiffaryr.store.security;

import com.ghiffaryr.store.security.JWT.JwtEntryPoint;
import com.ghiffaryr.store.security.JWT.JwtFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/**/predict").authenticated()

                .antMatchers("/seller/**/create").access("hasAnyRole('MANAGER')")
